...
const MovieCard = ({ movie: { title, vote_average, poster_path, id, release_date }, isNowPlaying, isComingSoon }) => {
    ...
    return (
        <div id={id} onClick={(e) => console.log(e.target)} className="card movie-card border-base-300 border-2 w-52 m-2 bg-base-100 shadow-xl cursor-pointer transition rounded-none z-10 relative">
