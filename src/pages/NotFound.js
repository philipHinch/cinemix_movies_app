...
const NotFound = ({ isChecked }) => {
    return (
        <div className={`p-2 xl:py-10 xl:px-28 lg:p-20 flex flex-col justify-center items-center h-screen transition-all ${ isChecked ? 'bg-white' : 'bg-neutral' }`} >
